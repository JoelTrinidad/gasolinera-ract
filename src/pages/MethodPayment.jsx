    ...
    <Box textAlign="center" marginBottom={10}>
      ...
      <Grid templateColumns="repeat(2, 1fr)" gap={9} marginTop={4}>
        {payments.map((payment, index) => (
          <GridItem key={index} padding="4" borderRadius="10" boxShadow="0px 4px 10px -3px rgb(117 117 117)" cursor="pointer" _hover={{ shadow: "2xl" }} onClick={() => console.log("click")}>
            <Box justifyContent="space-evenly" alignItems="center" marginTop={4} marginBottom={3}>
